          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div>
              <div className="mb-6 space-y-3">
                <p className="flex items-center gap-3 text-foreground"><MapPin className="h-5 w-5 text-secondary" /> <a href="https://maps.app.goo.gl/yL3hLPUjd19X92sJ9" target="_blank" rel="noopener noreferrer" className="hover:text-primary hover:underline">Via Cesare Battisti, 191, 98123 Messina (ME)</a></p>
