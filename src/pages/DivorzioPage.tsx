...
import { Users, Scale, MapPin, Phone } from "lucide-react";
    ...
    <Layout>
      ...
      <section id="contatti" className="bg-muted py-16 md:py-20">
        <div className="container mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="mb-8 text-muted-foreground">Per una consulenza sul divorzio, contatta lo studio.</p>
          ...
          <p className="mt-6 text-sm text-muted-foreground">
            <MapPin className="mr-1 inline h-4 w-4" /> <a href="https://maps.app.goo.gl/yL3hLPUjd19X92sJ9" target="_blank" rel="noopener noreferrer" className="hover:underline">Via Cesare Battisti, 191 – 98123 Messina</a> |
